...
class variables{
    public:
		...
		/*TTF_Font*/      
		static TTF_Font *font;//font for regular numbers [for now only used in inventory]
        ...
        bool fullscreen=false, //flag that defines whether or not the application should be launched in full-screen mode
		     ...
		     blend = false;
		/*float*/         
		float const LAYER_UI = -2.0f,
					LAYER_ENTITY = -1.0f,
					LAYER_BACKGROUND = -3.0f;
